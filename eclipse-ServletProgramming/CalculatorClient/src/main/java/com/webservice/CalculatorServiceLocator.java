...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.webservice.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8084/Calculator/services/Calculator";
    ...
    public com.webservice.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public com.webservice.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.webservice.CalculatorSoapBindingStub _stub = new com.webservice.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.webservice.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.webservice.CalculatorSoapBindingStub _stub = new com.webservice.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.com", "Calculator"));
        }
